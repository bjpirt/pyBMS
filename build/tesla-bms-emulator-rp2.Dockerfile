...
COPY platforms/canbed_dual/teslaBmsEmulator.py /mpy/micropython/ports/rp2/modules/teslaBmsEmulator.py
...
RUN echo "import teslaBmsEmulator" >> /mpy/micropython/ports/rp2/modules/_boot.py
